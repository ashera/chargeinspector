...
export default function SubmitPage({ navigate, initialDescriptor, initialMerchant }) {
  const { apiFetch } = useAuth();
  const [form, setForm]         = useState({ ...EMPTY, descriptor: initialDescriptor, merchantName: initialMerchant ?? '' });
